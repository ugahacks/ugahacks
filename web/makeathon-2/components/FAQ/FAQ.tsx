...
function Question({question, questionId, expandQuestion, expanded}: QuestionProps) {
  ...
  return (
    <div id={"questionBox-" + questionId} className={expanded? styles.question + " " + styles.expanded : styles.question}>
      <div className={styles.question_top}>
        <h1 id={"question-" + questionId}>{question.question}</h1>
        <div className={styles.expand_button} id={"button-" + questionId} onClick={()=>{expanded? expandQuestion(-1) : expandQuestion(questionId)}}>
  ...
  return (
    <section className={styles.body}>
      ...
      <div className={styles.faq_content}>
        <ul className={styles.questions}>{faqs.map((q, i) => <Question expanded={i == expandedIndex} expandQuestion={expandQuestion} question={q} questionId={i}/>)}</ul>
