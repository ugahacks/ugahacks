...
const faqData = [
  ...
  { question: "Can I apply for travel reimbursements?", answer: "Yes, we will be offering travel reimbursements! Please make sure to note it on your registration and we will reach out to you upon acceptance. University of Georgia students are not eligible to receive travel reimbursements."},
