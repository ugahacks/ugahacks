  ...
  return (
    <>
      ...
      >
        ...
        <nav className="hidden md:flex ml-4 md:ml-6 lg:ml-10 gap-4 sm:gap-6 md:gap-8 lg:gap-14 tracking-wider font-bold uppercase">
          <a
        ...
        <nav className="hidden md:flex ml-auto gap-4 md:gap-5 lg:gap-6 items-center">
          {/* Facebook */}
          <a
      ...
      {isMenuOpen && (
        <div className="md:hidden sticky top-20 z-40">
          ...
          >
            ...
            {/* Divider */}
            <div className="mx-4 my-2 h-px bg-white bg-opacity-20"></div>
            ...
            <div className="flex justify-center gap-4 px-4 py-2">
              ...
              >
                <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                  <span className="font-bold text-sm" style={{ color: "#4a4a85" }}>f</span>
                </div>
              </a>
