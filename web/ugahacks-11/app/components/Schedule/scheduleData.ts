...
export const schedule: DaySchedule[] = [
  {
    ...
    events: [
      ...
      {
        title: "Cox: Kahoot and Learn",
        time: "10-11:00 PM",
        location: "MLC 213",
      },
      {
        title: "NCR Voyix Challenge",
        time: "10-11:00 PM",
        location: "MLC 214",
      },
      { title: "Tractian Challenge", time: "10-11:00 PM", location: "MLC 148" },
      {
        title: "State Farm Challenge",
        time: "10-11:00 PM",
        location: "MLC 150",
      },
    ],
  },
  {
    ...
    events: [
      ...
      {
        title: "Intro React.js Workshop",
        time: "10-11:00 AM",
        location: "MLC 213",
      },
      { title: "Tractian Workshop", time: "10-11:00 AM", location: "MLC 148" },
      {
        title: "MLH: Coding with Google AI Studio Workshop",
        time: "10-11:00 AM",
        location: "MLC 147",
      },
      {
      ...
      {
        title:
          "Cox: Running with Scissors - Get Hands on with Cox Automotive Engineers",
        time: "11-12:00 PM",
        location: "MLC 213",
      },
      {
      ...
      {
        title: "Palantir Guest Speaker",
        time: "1-2:00 PM",
        location: "MLC 148",
      },
      { title: "AWS Workshop", time: "2-3:00 PM", location: "MLC 250" },
      {
        title: "Intro to Databases Workshop",
        time: "2-3:00 PM",
        location: "MLC 213",
      },
      ...
      {
        title: "House of Cards Challenge",
        time: "5-6:00 PM",
        location: "MLC 267",
      },
      ...
      {
        title: "Lettuce Eating Competition",
        time: "6-7:00 PM",
        location: "MLC 148",
      },
