  ...
  return (
    ...
    >
      <div className="relative z-10 w-full flex flex-col items-center pt-[1vh] md:pt-[35vh] px-4 md:px-20 pb-8 md:pb-32">
        ...
        <p className="text-white px-1 my-4 mx-auto bg-[#4A5C8C] font-encode-sans text-sm md:text-lg rounded">This event is supported in part by the President&apos;s Venture Fund through the generous gifts of University of Georgia donors.</p>
        <Link
