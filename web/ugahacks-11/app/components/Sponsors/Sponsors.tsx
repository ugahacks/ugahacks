   ...
   >
     ...
     <div className="relative z-10 w-full flex flex-col items-center pt-6 md:pt-16 px-4 md:px-20 pb-8 md:pb-32">
       ...
       <div className="w-full max-w-4xl grid grid-cols-3 gap-2 md:gap-6">
         <SponsorCard imageUrl="/sponsor1.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor2.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor3.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor4.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor5.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor6.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor7.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor8.png" href="https://example.com" />
         <SponsorCard imageUrl="/sponsor9.png" href="https://example.com" />
       </div>
       <button
