    ...
    <>
      <section className="section about" id="about">
        <div className="section-text about-text">
          ...
          <p>
            UGAHacks is an annual hackathon organized by fellow students at the
            University of Georgia in Athens, Georgia. Hackathons are all about
            groups of dedicated people coming together to create something
            amazing in an epic 48-hour programming sleepover.
          </p>
          <p>
