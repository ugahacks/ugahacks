...
export function mobileSite(): ReactElement {
  return (
    <body className={mobileStyle.body}>
      <div className={mobileStyle.leftSide}></div>
      <div className={mobileStyle.middle}>
        <div className={mobileStyle.title}>
          <div className={mobileStyle.logo}>
            <Image
              className={mobileStyle.logoTitle}
              src={titleWithByte}
              alt="logo"
            />
            <p className={mobileStyle.topText} style={{ margin: "0" }}>
      ...
      <div className={mobileStyle.rightSide}></div>
    </body>
  );
}
